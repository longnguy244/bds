        ...
        <div class="body">
            <div class="row clearfix">
                ...
                <div class= "col-md-6">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input data-inputmask-mask="9{10}" name="phone_kh" type="text" id="customer_phone" class="form-control" placeholder="Số điện thoại" value="{{ $data->phone_kh or old('phone_kh') }}">
                        </div>
                    </div>
