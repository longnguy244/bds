    ...
    <div class="container">
        <div class="hopdong">
            <div class="center">
                ...
                <p>----------</p>
                <h4>HỢP ĐỒNG MUA BÁN BẤT ĐỘNG SẢN</h4>
            ...
            <div class="dieukhoan">
                <p><b>Hai Bên cùng thỏa thuận ký hợp đồng dịch vụ với nội dung sau: </p>
                    ...
                    <p>1.3 Giá bất động sản này được hai Bên thỏa thuận trên cơ sở giá do Bên A thẩm định là:  {{$data->giaban}} VNĐ.(bằng chữ:  {{$data->giathue}} đồng)</p>
                ...
                <p><b> ĐIỀU 2:  PHÍ DỊCH VỤ VÀ PHƯƠNG THỨC THANH TOÁN</b></p>
                    <p>2.1 Bên B đồng ý thanh toán cho Bên A số tiền môi giới là {{$data->phi_mg}} VNĐ ( đã bao gồm thuế VAT) (Số tiền bằng chữ:  {{$data->phi_dangbai}}đồng.</p>
        ...
        <div class="export">
            <a class="btn" href="{{ route('down.hopdong',$data->id) }}">
