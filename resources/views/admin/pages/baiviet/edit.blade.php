...
<div class="card">
    ...
    <form name="formBaiViet" method="POST" action="{{ route('baiviet.update', ['data' => $data->id]) }}">
	{{ method_field('PUT') }}
    {{ csrf_field() }}
        <div class="body">
            <div class="row clearfix">
                ...
                <div class= "col-md-6">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input name="ten_bv" type="text" id="ten_bv" class="form-control" placeholder="Tên bài viết" value="{{ old('ten_bv', $data->ten_bv) }}">
                        </div>
                    </div>
                    <label for="alias">
                        Alias
                ...
                <div class= "col-md-6">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input name="trangthai" type="text" id="trangthai" class="form-control" placeholder="Trạng thái" value="{{ old('trangthai', $data->trangthai) }}">
                        </div>
                    </div>
                    <label for="bds_note">
                        Ghi chú
