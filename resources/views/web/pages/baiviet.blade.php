                   ...
                   @foreach($baiviet as $bv)
                    ...
                    <div class="single-blog-area mb-50">
                        ...
                        <div class="post-content">
                            <!-- Date -->
                            <div class="post-date">
                                <a href="#">{{ $bv->created_at->format('M d, Y') }}</a>
                            </div>
                            <!-- Headline -->
                            <a href="{{ asset('/baiviet/'. $bv->alias) }}" class="headline">{{ $bv->ten_bv }}</a>
                            <!-- Post Meta -->
                            <div class="post-meta">
                            ...
                            <!-- Read More btn -->
                            <a href="{{ asset('/baiviet/'. $bv->alias) }}" class="btn south-btn">Read More</a>
                        </div>
                    </div>
                   @endforeach
                    <!-- Single Blog Area -->
                    <div class="single-blog-area mb-50">
                        <!-- Post Thumbnail -->
                        <div class="blog-post-thumbnail">
                            <img src="{{ asset('south/img/blog-img/blog2.jpg') }}" alt="">
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            <!-- Date -->
