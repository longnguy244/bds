...
class BienBanController extends Controller
{
     ...
     */
    public function __construct(BIENBANHOPDONG $model, Request $request)
    {
        $this->model    = $model;
    }
    ...
    {
        return view('admin.pages.bienban.index',[
            'auth'          => \Auth::user(),
            'data'          => $this->model->all(),
    ...
    {
        return view('admin.pages.bienban.create',[
            'auth'          => \Auth::user(),
            'hopdong'     => HOPDONG::all(),
            'route'         => $this->model->route
        ]);
    ...
    {
        return view('admin.pages.bienban.edit',[
            'auth'          => \Auth::user(),
            'hopdong'     => HOPDONG::all(),
