...
class PhieuThuController extends Controller
{
     ...
     */
    public function __construct(PHIEUTHU $model, Request $request)
    {
        $this->model    = $model;
    }
    ...
    {
        return view('admin.pages.phieuthu.index',[
            'auth'          => \Auth::user(),
            'data'          => $this->model->all(),
    ...
    {
        return view('admin.pages.phieuthu.create',[
            'auth'          => \Auth::user(),
    ...
    {
        return view('admin.pages.phieuthu.edit',[
            'auth'          => \Auth::user(),
            'nhanvien'      => NHANVIEN::all(),
            'hopdong'     => HOPDONG::all(),
