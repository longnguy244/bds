...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 09, 2018 lúc 12:28 PM
...
(6, 2, 4, 3, 'Con đê', 'con-de', 'con-de.jpg', '12/1/a/a', '3123123', '1', '2018-12-08 13:08:13', '2018-12-08 13:09:36', '1', 'Cho thuê', 10000),
...
--
-- Các ràng buộc cho bảng `bienbanthanhly`
--
ALTER TABLE `bienbanthanhly`
...
--
-- Các ràng buộc cho bảng `hinhthucthanhtoan`
--
ALTER TABLE `hinhthucthanhtoan`
...
--
-- Các ràng buộc cho bảng `motabds`
--
ALTER TABLE `motabds`
