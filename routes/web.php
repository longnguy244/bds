...
Route::group(['middleware' => 'customer'], function(){
    ...
    Route::get('hopdong/{id}', 'Web\PaymentController@hopdong')->name('get.hopdong');
...
Route::get('chatbox/index','ChatBoxController@index')->name('get.chatbox');
Route::get('sell/{id}','Web\BDSController@sell')->name('get.sell');
